package com.example.tuanpham.demoinstacapturewithmap;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCapture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ivPreview.getVisibility() == View.INVISIBLE) {
                    ivPreview.setVisibility(View.VISIBLE);
                    captrueScreen();
                    btnCapture.setText("Close Preview");
                } else {
    ...
    private void captrueScreen() {
        InstaCapture.getInstance(this).capture(findViewById(R.id.btn_capture)).setScreenCapturingListener(new ScreenCaptureListener() {
